    ...
    >
      ...
      <div className="flex gap-2 mt-4">
        ...
        <button
          ...
          className="w-full py-2 rounded-md flex justify-center items-center gap-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white hover:to-purple-700 active:scale-95 cursor-pointer transition"
        >
        ...
        <button
          ...
          className="flex justify-center items-center w-16 border text-slate-500 group rounded-md cursor-pointer transition active:scale-95"
        >
