      ...
      <div className="flex gap-4 pb-5">
        ...
        {stories.map((story, index) => (
          <div
            ...
            key={index}
            className={`relative rounded-lg shadow-sm min-w-30 max-w-30 max-h-40 aspect-[3/4] cursor-pointer hover:shadow-lg transition-all duration-200 border border-gray-200 bg-gradient-to-b from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800 active:scale-95`}
          >
            <img
              src={story.user.profile_picture}
              alt=""
              className="absolute size-8 rounded-full ring ring-gray-100 shadow z-10 top-3 left-3"
            />
        ...
        {/* {show story modal} */}
        {showModel && <StoryModal setShowModal={setShowModel} fetchStories={fetchStories}/>}
