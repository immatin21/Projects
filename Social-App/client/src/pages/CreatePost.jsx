...
const CreatePost = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <div className="max-w-6xl mx-2 md:mx-8 p-6">
        {/* Title */}
        <div className="mb-8">
              ...
              {images.map((image, i) => (
                <div key={i} className="relative group">
                  ...
                  <div
                    ...
                    className="absolute hidden group-hover:flex top-0 right-0 bottom-0 left-0 justify-center items-center bg-black/40 rounded-md cursor-pointer"
                  >
